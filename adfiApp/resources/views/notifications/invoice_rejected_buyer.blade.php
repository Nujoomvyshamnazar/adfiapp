							...
							<tr>
								<td align="center">
									<div class="editable-img">
										<img editable="true" mc:edit="image009" src="{{asset('assets/images/invoice-icon-one.png')}}"  style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
									</div>
								</td>
							</tr>
							...
							<tr>
								<td mc:edit="text012" align="left" class="center_content text_color_a1a2a5" style="color: #a1a2a5; font-size: 14px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
												<p>Your invoice dated _______________ with invoice number ________________ with transaction reference number __________________ has been rejected by M/s KM Trading quoting the reason ___________________which has been updated in your portal. Kindly proceed to resubmit the invoice for buyer confirmation and approval by rectifying the reject reason latest by  ___________________(Two days from rejection date) to avoid cancellation of the transaction with ADFI.</p>
