							...
							<tr>
								<td align="center">
									<div class="editable-img">
										<img editable="true" mc:edit="image009" src="{{asset('assets/images/invoicepending-icon-one.png')}}"  style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
									</div>
								</td>
							</tr>
							...
							<tr>
								<td mc:edit="text012" align="left" class="center_content text_color_a1a2a5" style="color: #a1a2a5; font-size: 14px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
												<p>Your early payment offer for invoice dated _______________ with invoice number ________________ with transaction reference number __________________is pending for acceptance from our funders. ADFI is endeavoring to present the offer to other prospective funders. In the event of non-receipt confirmation of acceptance by ________________________(Three days from this intimation date) the offer shall be returned to your portal. If you would like to resubmit the offer kindly revise the offer with a higher offer rate for us to present to our prospective funders. </p>
