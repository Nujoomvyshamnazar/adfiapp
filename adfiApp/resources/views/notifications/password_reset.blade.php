							...
							<tr>
								<td align="center">
									<div class="editable-img">
										<img editable="true" mc:edit="image009" src="{{asset('assets/images/circle-icon-password.png')}}"  style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
									</div>
								</td>
							</tr>
							...
							<tr>
								<td mc:edit="text012" align="left" class="center_content text_color_a1a2a5" style="color: #a1a2a5; font-size: 14px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
												<p>You recently Requested to reset your Password for your ADFI Supplier Account.Click the botton below to reset it.</p>
										...
										<tr>
											<td mc:edit="text004" align="center" valign="middle" style="color: #ffffff; font-size: 16px; font-weight: 600; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;" class="text_color_ffffff">
												<div class="editable-text">
													<span class="text_container">
														<multiline>
															<a href="#" style="text-decoration: none; color: #ffffff;">Reset Password</a>
														</multiline>
													</span>
												</div>
											</td>
							...
							<tr>
								<td mc:edit="text013" align="left" class="center_content text_color_a1a2a5" style="color: #a1a2a5; font-size: 14px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
											 <p>if you did not request a password reset,Please ignore this email or reply to us know.This password reset is only valid for the next 30 minutes</p>
											</multiline>
										</span>
									</div>
								</td>
