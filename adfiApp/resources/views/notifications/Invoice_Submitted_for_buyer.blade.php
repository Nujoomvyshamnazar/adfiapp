							...
							<tr>
								<td mc:edit="text012" align="left" class="center_content text_color_a1a2a5" style="color: #a1a2a5; font-size: 14px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
												<p>Your invoice dated _______________ with invoice number ________________has been submitted to M/s KM Trading successfully with transaction reference number __________________. We expect to receive the confirmation from the buyer on or before ________________(Two days from submission date). We will confirm back on the approval status by __________________. </p>
