...
@section('title', 'Admin/Investor Institutional List')

@section('maintitle', 'Investor Institutional List')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="livicon" data-name="responsive" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Investor Institutional List
                                </div>
                            </div>
