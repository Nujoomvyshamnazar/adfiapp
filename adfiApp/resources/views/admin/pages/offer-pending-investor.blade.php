...
@section('title', 'Offer Pending With Investor')

@section('maintitle', 'Offer Pending With Investor')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="livicon" data-name="responsive" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Offer Pending With Investor
                                </div>
                            </div>
