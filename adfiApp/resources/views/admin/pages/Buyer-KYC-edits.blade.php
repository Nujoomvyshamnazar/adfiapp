...
@section('title', 'Buyer KYC Edits')

@section('maintitle', 'Buyer KYC Edits')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="livicon" data-name="responsive" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Buyer KYC Edits
                                </div>
                            </div>
