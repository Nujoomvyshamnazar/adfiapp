...
@section('title', 'Admin/Investor KYC List')

@section('maintitle', 'Investor KYC List')
                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <i class="livicon" data-name="responsive" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Investor KYC List
                                </div>
                            </div>
