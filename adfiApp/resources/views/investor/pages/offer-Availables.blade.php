...
@section('title', 'Offer Available')

@section('maintitle', 'Offer Available')
...
<section class="content">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="livicon" data-name="responsive" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Offer Available
                                </div>
                            </div>
  ...
  <td>Intel</td>
                                            ...
                                            <td>
<button type="button" class="btn btn-primary btn_sizes">Pay Early</button>
