                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group required">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <input type="text" class="form-control required" id="Entity_Name"  placeholder=""  >
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <input type="text" class="form-control required" id="Nature_of_Business"  placeholder=""  >
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <input type="text" class="form-control required" id="Incorporation_date:"  placeholder=""  >
                                                                        </div>
                                                                    </div>
              ...
              <div class="panel panel-primary">
                  ...
                  <div class="panel-body table-responsive">
                          ...
                          <tbody>
                              <tr>
                                  <td>1.</td>
                                  <td><input id="name" name="name" type="text" placeholder="" class="form-control"></div></td>
                                  <td>

                                    <input id="name" name="name" type="text"  placeholder=""  class="col-md-3 form-control"></div>
