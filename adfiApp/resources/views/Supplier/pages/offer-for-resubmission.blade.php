...
@section('title', 'Offer For Resubmission')
@section('maintitle', 'Offer For Resubmission')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="livicon" data-name="responsive" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Offer For Resubmission
                                </div>
                            </div>
...
<div class="modal fade in" id="responsive1" tabindex="-1" role="dialog" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">Resubmitted Early Payment Offer</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                  <div class="panel-body">
