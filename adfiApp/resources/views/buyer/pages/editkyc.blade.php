             ...
             <div class="panel panel-success">
                 <div class="panel-heading">
                     <h3 class="panel-title">
                         <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Edit KYC
                     </h3>
                 ...
                 <div class="panel-body">
                     <form id="commentForm" method="post" action="#">
                         <div id="rootwizard">
                             <ul>
                                 <li>
                                     <a href="#tab1" data-toggle="tab">Basic Details</a>
                                 </li>
                                 <li>
                                     <a href="#tab2" data-toggle="tab">Transaction Profile</a>
                                 </li>
                                 <li>
                                     <a href="#tab3" data-toggle="tab">Documents Uploads</a>
                                 </li>
                             </ul>
                             <div class="tab-content">
                                 <div class="tab-pane" id="tab1">
                                     ...
                                     <div class="form-group">
                                         <label for="userName" class="control-label">Name Of the Company *</label>
                                         <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>
                                     <div class="form-group">
                                         <label for="email" class="control-label">Contact Details *</label>
                                      <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>
                                     <div class="form-group">
                                         <label for="password" class="control-label">Promoter Details *</label>
                                          <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>
                                     <div class="form-group">
                                         <label for="confirm" class="control-label">Ownership Pattern *</label>
                                           <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>


                                     <div class="form-group">
                                         <label for="confirm" class="control-label">Registration details *</label>
                                           <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>

                                     <div class="form-group">
                                         <label for="confirm" class="control-label">Business Model *</label>
                                           <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>

                                     <div class="form-group">
                                         <label for="confirm" class="control-label">Main Suppliers *</label>
                                           <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>

                                     <div class="form-group">
                                         <label for="confirm" class="control-label">Main Buyers *</label>
                                           <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>

                                     <div class="form-group">
                                         <label for="confirm" class="control-label">Bank Details *</label>
                                           <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>

                                     <div class="form-group">
                                         <label for="confirm" class="control-label">Signatory Profile *</label>
                                           <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>

                                     <div class="form-group">
                                         <label for="confirm" class="control-label">Key Employees *</label>
                                           <input id="userName" name="companyname" type="text" placeholder="Enter your name" class="form-control required">
                                     </div>
                                 </div>
